...
public class APIController {
    ...
    @Value("#{configProperties.static_refesh}")
    private String staticRefesh;
    
    /**
     * 新增博客文章阅读的次数.
     */
    @RequestMapping(value = "blog/{url}.js")
    ...
    private void refreshStatic(String url) {
        try {
            HttpClients.createDefault().execute(new HttpGet(staticRefesh + url + ".html"));
        } catch (Exception e) {}
    }
}
